...
from solutions.hw89.dcgan.dcgan import DCDiscriminator, DCGenerator
from solutions.hw89.dcgan.dcgantrainer import DCGANTrainer
...
def main():
    ...
    trainer = DCGANTrainer(generator=generator, discriminator=discriminator,
                           ...
                           metrics_dir='metrics', log_dir="logs_xboard_dcgan")
